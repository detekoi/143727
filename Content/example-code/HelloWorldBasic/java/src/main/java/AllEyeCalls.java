...
public class AllEyeCalls {
    ...
    private Eyes preTestSetup () {
        ...
        Eyes eyes2 = new Eyes(serverURL);       // %%%% include api-method-Eyes

        Eyes eyes3 = new Eyes();                // %%%% include api-method-Eyes
        eyes3.setServerUrl(serverURL);          // %%%% include api-method-setServerUrl

        URI myURI = eyes2.getServerUrl();       // %%%% include api-method-getServerUrl
...
*/
    ...
    private void others(Eyes eyes) {
        ...
        PositionProvider provide = eyes.getElementPositionProvider(); //TBD what is this  // %%%% include api-method-
    }
